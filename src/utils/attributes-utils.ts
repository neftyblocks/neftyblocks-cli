...
export const integerTypes = ['uint8', 'int16', 'int32', 'int64', 'uint8', 'uint16', 'uint32', 'uint64', 'fixed8', 'fixed16', 'fixed32', 'fixed64'];
...
export function isValidAttribute(type: string, value: string | number | boolean ){
