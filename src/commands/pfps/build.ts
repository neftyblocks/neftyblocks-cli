...
export default class BuildPfpsCommand extends BaseCommand {
  static examples = [
    {
      ...
      description: 'Uploads all the pfps in the ./pfpfs folder to ipfs.',
    },
  ];
  static description = 'Uploads all the pfps generated by the generate command to ipfs.';
  ...
  public async run(): Promise<void> {
    ...
    const namedPfs = pfpManifest.pfps.map((pfp: Pfp, index: number) => {
      const formattedNumber = `000${index + 1}`.slice(-4);
