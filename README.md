...
running command...
$ nefty (--version)
@nefty/cli/0.3.0 darwin-arm64 node-v18.12.1
$ nefty --help [COMMAND]
USAGE
  $ nefty COMMAND
...
...
* [`nefty generate asset-transfer-file OUTPUT`](#nefty-generate-asset-transfer-file-output)
...
_See code: [dist/commands/assets/index.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/assets/index.ts)_
...
_See code: [dist/commands/assets/mint.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/assets/mint.ts)_

## `nefty assets transfer INPUT`

Transfers assets in batches using a spreadsheet.

```
USAGE
  $ nefty assets transfer INPUT [-b <value>]

ARGUMENTS
  INPUT  Excel file with the assets and new owners

FLAGS
  -b, --batchSize=<value>  [default: 200] Transactions batch size

DESCRIPTION
  Transfers assets in batches using a spreadsheet.

EXAMPLES
  $ nefty assets transfer test.xls
```

_See code: [dist/commands/assets/transfer.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/assets/transfer.ts)_
...
_See code: [dist/commands/config/index.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/config/index.ts)_
...
_See code: [dist/commands/config/auth.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/config/auth.ts)_
...
_See code: [dist/commands/config/get.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/config/get.ts)_
...
_See code: [dist/commands/config/init.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/config/init.ts)_
...
_See code: [dist/commands/config/set.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/config/set.ts)_
...
_See code: [dist/commands/generate/index.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/generate/index.ts)_

## `nefty generate asset-transfer-file OUTPUT`

Generates the file to transfer assets.

```
USAGE
  $ nefty generate asset-transfer-file OUTPUT [-c <value>] [-s <value>] [-t <value>] [-o <value>]

ARGUMENTS
  OUTPUT  Location where the file will be generated.

FLAGS
  -c, --collection=<value>  Collection name
  -o, --owner=<value>       Owner
  -s, --schema=<value>      Schema name
  -t, --template=<value>    Template id

DESCRIPTION
  Generates the file to transfer assets.

EXAMPLES
  Generates the file to transfer assets into a file called transfers.xlsx.

    $ nefty generate asset-transfer-file transfers.xlsx
```

_See code: [dist/commands/generate/asset-transfer-file.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/generate/asset-transfer-file.ts)_
...
_See code: [dist/commands/generate/mint-file.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/generate/mint-file.ts)_
...
_See code: [dist/commands/generate/pfp-file.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/generate/pfp-file.ts)_
...
_See code: [dist/commands/generate/template-file.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/generate/template-file.ts)_
...
_See code: [dist/commands/generate/token-transfer-file.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/generate/token-transfer-file.ts)_
...
_See code: [dist/commands/pfps/index.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/pfps/index.ts)_
...
_See code: [dist/commands/pfps/generate.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/pfps/generate.ts)_
...
_See code: [dist/commands/templates/index.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/templates/index.ts)_
...
_See code: [dist/commands/templates/create.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/templates/create.ts)_
...
_See code: [dist/commands/templates/export.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/templates/export.ts)_
...
_See code: [dist/commands/tokens/index.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/tokens/index.ts)_
...
_See code: [dist/commands/tokens/transfer.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.3.0/src/commands/tokens/transfer.ts)_
<!-- commandsstop -->
