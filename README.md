...
running command...
$ nefty (--version)
@nefty/cli/0.2.4 darwin-arm64 node-v18.19.1
$ nefty --help [COMMAND]
USAGE
  $ nefty COMMAND
...
...
* [`nefty pfps prepare INPUT`](#nefty-pfps-prepare-input)
* [`nefty pfps upload INPUT`](#nefty-pfps-upload-input)
...
_See code: [src/commands/assets/index.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/assets/index.ts)_
...
_See code: [src/commands/assets/mint.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/assets/mint.ts)_
...
_See code: [src/commands/config/index.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/config/index.ts)_
...
_See code: [src/commands/config/auth.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/config/auth.ts)_
...
_See code: [src/commands/config/get.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/config/get.ts)_
...
_See code: [src/commands/config/init.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/config/init.ts)_
...
_See code: [src/commands/config/set.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/config/set.ts)_
...
_See code: [src/commands/generate/index.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/generate/index.ts)_
...
_See code: [src/commands/generate/mint-file.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/generate/mint-file.ts)_
...
_See code: [src/commands/generate/pfp-file.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/generate/pfp-file.ts)_
...
_See code: [src/commands/generate/template-file.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/generate/template-file.ts)_
...
_See code: [src/commands/generate/token-transfer-file.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/generate/token-transfer-file.ts)_
...
_See code: [src/commands/pfps/index.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/pfps/index.ts)_
...
_See code: [src/commands/pfps/generate.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/pfps/generate.ts)_

## `nefty pfps prepare INPUT`

Creates the xlsx file to mint the pfps.

```
USAGE
  $ nefty pfps prepare INPUT -t <value> -c <value> [-r] [-a <value>]
...
EXAMPLES
  Generates the mint file from the pfps in the ./pfps-folder and saves it in the mint-pfps.xlsx file.

    $ nefty pfps prepare ./pfps-folder ./mint-pfps.xlsx
```

_See code: [src/commands/pfps/prepare.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/pfps/prepare.ts)_

## `nefty pfps upload INPUT`

Uploads all the pfps generated by the generate command to ipfs.
...
EXAMPLES
  Uploads all the pfps in the ./pfpfs folder to ipfs.

    $ nefty pfps upload ./pfps-folder
```

_See code: [src/commands/pfps/upload.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/pfps/upload.ts)_
...
_See code: [src/commands/templates/index.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/templates/index.ts)_
...
_See code: [src/commands/templates/create.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/templates/create.ts)_
...
_See code: [src/commands/templates/export.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/templates/export.ts)_
...
_See code: [src/commands/tokens/index.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/tokens/index.ts)_
...
_See code: [src/commands/tokens/transfer.ts](https://github.com/neftyblocks/neftyblocks-cli/blob/v0.2.4/src/commands/tokens/transfer.ts)_
<!-- commandsstop -->
